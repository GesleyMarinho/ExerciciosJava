package LogicaProgramacao.beecrowd.ex01.ex03;
/*
*
* Raju e Meena adoram jogar um jogo diferente com pequenas peças de mármores, chamados Marbles.
* Eles têm um monte destas peças com números escritos neles.
        ...
        while (true) {
            ...
            for (int i = 0; i < Q; i++) {
                ...
                if (index >= 0) {
                    ...
                    System.out.println(query + " found at " + (index + 1));
                } else {
